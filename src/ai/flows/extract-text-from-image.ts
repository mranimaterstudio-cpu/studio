...
'use server';
/**
 * @fileOverview An AI agent for extracting text from an image (OCR).
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an Optical Character Recognition (OCR) specialist. Your task is to accurately extract all text from the provided image.
